/* Generated from dashboard.jsx — run: npm run compile */
/* eslint-disable */
const {
  useMemo,
  useState,
...
function Slicer({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "text-[11px] font-semibold uppercase tracking-section text-mck-gray"
...
function KpiCell({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "border-r border-mck-line px-4 py-3 last:border-r-0 md:px-5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-[11px] font-semibold uppercase tracking-section text-mck-gray"
  }, title), /*#__PURE__*/React.createElement("div", {
    className: "kpi-num mt-2 font-serif text-[28px] font-semibold leading-none text-mck-navy md:text-[32px]"
  }, value), hint ? /*#__PURE__*/React.createElement("div", {
    className: "mt-1.5 text-xs text-mck-gray"
  }, hint) : null);
}
function ChartTooltip({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "border border-mck-line bg-white px-3 py-2 text-xs shadow-sm"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mb-1.5 font-semibold text-mck-navy"
  }, label), payload.map(p => /*#__PURE__*/React.createElement("div", {
    key: p.dataKey,
    className: "flex items-center justify-between gap-8 py-0.5"
  }, /*#__PURE__*/React.createElement("span", {
    className: "flex items-center gap-2 text-mck-gray"
  }, /*#__PURE__*/React.createElement("span", {
    ...
    className: "kpi-num font-medium text-mck-navy"
  }, fmt(p.value)))), /*#__PURE__*/React.createElement("div", {
    className: "mt-1.5 border-t border-mck-line pt-1.5 font-semibold text-mck-navy"
...
function PieTooltip({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "font-semibold text-mck-navy"
  }, p.name), /*#__PURE__*/React.createElement("div", {
    className: "kpi-num text-mck-gray"
  }, fmt(p.value), " Units (", (p.payload.pct || 0).toFixed(1), "%)"));
}
function SectionHead({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "mb-5 flex flex-col gap-3 border-b border-mck-line pb-4 lg:flex-row lg:items-end lg:justify-between"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "mb-2 flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-[11px] font-semibold tracking-section text-mck-teal"
  }, number), /*#__PURE__*/React.createElement("div", {
    className: "mck-rule"
  })), /*#__PURE__*/React.createElement("h2", {
    className: "font-serif text-2xl font-semibold tracking-tight text-mck-navy md:text-[28px]"
  }, title), subtitle ? /*#__PURE__*/React.createElement("p", {
    className: "mt-1 max-w-2xl text-sm text-mck-gray"
...
function HbUpcPanel({
  ...
  return /*#__PURE__*/React.createElement("section", {
    className: "mck-panel mb-8 p-5 md:p-6"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mb-5 flex flex-col gap-3 border-b border-mck-line pb-4 sm:flex-row sm:items-end sm:justify-between"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "mb-2 flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("span", {
    className: "text-[11px] font-semibold tracking-section text-mck-teal"
    ...
    className: "font-serif text-2xl font-semibold tracking-tight text-mck-navy md:text-[28px]"
  }, "HB Unit per Carton"), /*#__PURE__*/React.createElement("p", {
    className: "mt-1 text-sm text-mck-gray"
  }, "HighBay density by division · Units / LPN count", asOf ? " · as of " + asOf : "")), /*#__PURE__*/React.createElement("div", {
    className: "text-right"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-[10px] font-semibold uppercase tracking-section text-mck-gray"
  }, "HighBay overall"), /*#__PURE__*/React.createElement("div", {
    className: "kpi-num font-serif text-2xl font-semibold text-mck-navy"
  }, fmtUpc(overall)))), /*#__PURE__*/React.createElement("div", {
    className: "grid gap-4 md:grid-cols-3"
  }, rows.map(r => {
    const widthPct = Math.round((r.upc || 0) / maxUpc * 100);
    return /*#__PURE__*/React.createElement("div", {
      key: r.key,
      className: "border border-mck-line bg-white p-4"
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: "text-sm font-semibold text-mck-navy"
    }, r.label)), /*#__PURE__*/React.createElement("span", {
      className: "text-[11px] text-mck-gray"
    }, r.hint)), /*#__PURE__*/React.createElement("div", {
      className: "kpi-num mt-3 font-serif text-[40px] font-semibold leading-none text-mck-navy"
    }, fmtUpc(r.upc)), /*#__PURE__*/React.createElement("div", {
      className: "mt-1 text-xs text-mck-gray"
    }, "units / carton"), /*#__PURE__*/React.createElement("div", {
      className: "mt-4 h-1.5 w-full bg-mck-soft"
    }, /*#__PURE__*/React.createElement("div", {
      className: "h-1.5",
      style: {
        width: widthPct + "%",
      ...
      className: "mt-3 flex justify-between gap-3 text-[11px] text-mck-gray"
    }, /*#__PURE__*/React.createElement("span", null, fmt(r.units), " units"), /*#__PURE__*/React.createElement("span", null, fmt(r.cartons), " LPN")));
  })));
}
...
const SLICER_COMBOS = [{
  ...
  storage: "Total",
  metric: "Carton",
  label: "Total · by Carton"
}, {
  storage: "Total",
  metric: "SKU",
  label: "Total · by SKU Count"
}, {
  storage: "HighBay",
  metric: "Unit",
  label: "HighBay · by Unit"
}, {
  storage: "HighBay",
  metric: "Carton",
  label: "HighBay · by Carton"
}, {
  storage: "HighBay",
  metric: "SKU",
  label: "HighBay · by SKU Count"
}, {
  storage: "INFINITY",
  metric: "Unit",
  label: "INFINITY · by Unit"
}, {
  storage: "INFINITY",
  metric: "Carton",
  label: "INFINITY · by Carton"
}, {
  storage: "INFINITY",
  metric: "SKU",
  label: "INFINITY · by SKU Count"
}, {
  storage: "Pickface",
  metric: "Unit",
  label: "Pickface · by Unit"
}, {
  storage: "Pickface",
  metric: "SKU",
  label: "Pickface · by SKU Count"
}];
...
async function downloadInteractivePdf(rootEl, meta) {
  ...
  function addFooter(title) {
    ...
    pdf.textWithLink("Contents", pageW - margin - 22, pageH - 4, {
      pageNumber: 1
    });
    pdf.link(pageW - margin - 24, pageH - 8, 24, 6, {
      pageNumber: 1
    });
  }
  function drawSlicerBar(activeStorage, activeMetric) {
    ...
    STORAGE_OPTS.forEach(s => {
      ...
      if (page) pdf.link(x, barY, w, btnH, {
        pageNumber: page
      });
      x += w + 2;
    });
    ...
    x += 16;
    const metrics = activeStorage === "Pickface" ? [{
      id: "Unit",
      label: "by Unit"
    }, {
      id: "SKU",
  ...
  tocY += 10;
  const tocMain = [{
    title: "01  Daily inventory by storage",
    page: pageStarts["pdf-section-01"] || 2
  }, {
    title: "02  HB Unit per Carton",
    page: pageStarts["pdf-section-02"] || 2
  }, {
    title: "03  Season mix",
    page: pageStarts["pdf-section-03"] || 2
  }, {
    title: "04  Life cycle",
    page: pageStarts["pdf-section-04"] || 2
  }];
  if (pdf.outline && typeof pdf.outline.add === "function") {
    try {
      pdf.outline.add(null, DASHBOARD_TITLE, {
        pageNumber: 1
      });
    } catch (e) {}
  }
  tocMain.forEach(item => {
    pdf.setFontSize(11);
    pdf.setTextColor(0, 169, 206);
    pdf.textWithLink(item.title, margin, tocY, {
      pageNumber: item.page
    });
    pdf.link(margin, tocY - 4, 150, 7, {
      pageNumber: item.page
    });
    pdf.setTextColor(160, 170, 180);
    pdf.text(String(item.page), pageW - margin - 8, tocY, {
      align: "right"
    });
    if (pdf.outline && typeof pdf.outline.add === "function") {
      try {
        pdf.outline.add(null, item.title, {
          pageNumber: item.page
        });
      } catch (e) {}
    }
  ...
  SLICER_COMBOS.forEach(combo => {
    ...
    pdf.setFontSize(9);
    pdf.setTextColor(0, 169, 206);
    pdf.textWithLink("   -  " + combo.label, margin, tocY, {
      pageNumber: page
    });
    pdf.link(margin, tocY - 3.5, 120, 5, {
      pageNumber: page
    });
    pdf.setTextColor(160, 170, 180);
    pdf.text(String(page), pageW - margin - 8, tocY, {
      align: "right"
    });
    if (pdf.outline && typeof pdf.outline.add === "function") {
      try {
        pdf.outline.add(null, "01 - " + combo.label, {
          pageNumber: page
        });
      } catch (e) {}
    }
...
function App() {
  ...
  useEffect(() => {
    if (data) return;
    fetch("./data/inventory.json").then(r => r.ok ? r.json() : Promise.reject()).then(j => setData(j)).catch(() => setStatus("Data file missing. Use Update Data to upload inventory.json."));
  }, [data]);
  useEffect(() => {
  ...
  const dailyChart = useMemo(() => {
    ...
    return data.daily.map(d => {
      ...
      const total = s[tk];
      const capacityPct = activeCapacity && activeCapacity > 0 ? total / activeCapacity * 100 : null;
      return {
        date: fmtDate(d.date),
        AP: s.AP[mk],
        FW: s.FW[mk],
  ...
  if (!data) {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "mck-rule mb-4"
    }), /*#__PURE__*/React.createElement("h1", {
      className: "font-serif text-3xl font-semibold text-mck-navy"
    }, DASHBOARD_TITLE), /*#__PURE__*/React.createElement("p", {
      className: "mt-3 text-sm text-mck-gray"
    }, status || "Loading..."), /*#__PURE__*/React.createElement("button", {
      type: "button",
      onClick: onUpdateClick,
      className: "mt-6 w-fit bg-mck-navy px-4 py-2 text-sm font-semibold text-white"
    }, "Update Data"), /*#__PURE__*/React.createElement("input", {
      ref: fileRef,
      type: "file",
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "border-b border-mck-navy bg-mck-navy"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mx-auto flex max-w-[1280px] items-center justify-between gap-4 px-5 py-3 md:px-8"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-[11px] font-semibold uppercase tracking-section text-white/70"
  }, "1088 Inventory Analytics"), /*#__PURE__*/React.createElement("div", {
    className: "text-[11px] text-white/60"
  }, "Confidential"))), /*#__PURE__*/React.createElement("div", {
    className: "mx-auto max-w-[1280px] px-5 py-8 md:px-8 md:py-10"
  }, /*#__PURE__*/React.createElement("header", {
    className: "mb-8 flex flex-col gap-5 border-b border-mck-line pb-6 lg:flex-row lg:items-end lg:justify-between"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "mb-3 flex items-center gap-3"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mck-rule"
  }), /*#__PURE__*/React.createElement("span", {
    className: "text-[11px] font-semibold uppercase tracking-section text-mck-teal"
  }, "Executive Dashboard")), /*#__PURE__*/React.createElement("h1", {
    className: "font-serif text-[30px] font-semibold leading-tight text-mck-navy md:text-[40px]"
  }, DASHBOARD_TITLE), /*#__PURE__*/React.createElement("p", {
    className: "mt-2 max-w-2xl text-sm leading-relaxed text-mck-gray md:text-[15px]"
  }, "Daily stock by storage zone, season mix, and life-cycle posture across HighBay, INFINITY, and Pickface.")), /*#__PURE__*/React.createElement("div", {
    className: "no-print flex flex-col gap-2 sm:flex-row sm:items-stretch"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mck-panel px-4 py-2.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-[10px] font-semibold uppercase tracking-section text-mck-gray"
  }, "Data as of"), /*#__PURE__*/React.createElement("div", {
    className: "kpi-num mt-0.5 text-sm font-semibold text-mck-navy"
  }, data.latestDateLabel || fmtDate(data.latestDate))), /*#__PURE__*/React.createElement("button", {
    type: "button",
  ...
  }, pdfBusy ? "Preparing PDF..." : "Download Interactive PDF"), /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: onUpdateClick,
    ...
    className: "mb-4 text-sm text-mck-tealDeep"
  }, status) : null, /*#__PURE__*/React.createElement("div", {
    className: "mb-6 text-xs text-mck-gray"
  }, "Source ", data.sourceFile || "inventory.json", " · ", fmt(data.recordCount), " records · Generated ", data.generatedAt ? new Date(data.generatedAt).toLocaleString() : "-"), /*#__PURE__*/React.createElement("div", {
    id: "pdf-section-01"
  }, /*#__PURE__*/React.createElement("section", {
    className: "mck-panel mb-8 grid grid-cols-2 xl:grid-cols-4"
  }, /*#__PURE__*/React.createElement(KpiCell, {
    title: "Latest " + unitLabel,
    value: fmt(latestStorage ? latestStorage[tk] : 0),
    hint: storage + " · " + (metricOpts.find(m => m.id === metric)?.label || metric)
  }), /*#__PURE__*/React.createElement(KpiCell, {
    title: "AP",
    value: fmt(latestStorage ? latestStorage.AP[mk] : 0),
    hint: "Division 10"
  }), /*#__PURE__*/React.createElement(KpiCell, {
    title: "FW",
    value: fmt(latestStorage ? latestStorage.FW[mk] : 0),
    hint: "Division 20"
  }), /*#__PURE__*/React.createElement(KpiCell, {
    title: "EQ",
    value: fmt(latestStorage ? latestStorage.EQ[mk] : 0),
    hint: "Division 30"
  })), /*#__PURE__*/React.createElement("section", {
    className: "mck-panel mb-8 p-5 md:p-6"
    ...
    right: /*#__PURE__*/React.createElement("div", {
      className: "pdf-slicer-host flex flex-col gap-3"
  ...
  })), capacityLines.map(line => /*#__PURE__*/React.createElement(ReferenceLine, {
    key: line.name,
    y: line.value,
    stroke: line.color,
    strokeDasharray: "6 4",
    ...
    id: "pdf-section-02"
  }, /*#__PURE__*/React.createElement(HbUpcPanel, {
    highBay: latestHighBay,
    asOf: data.latestDateLabel || fmtDate(data.latestDate)
  })), /*#__PURE__*/React.createElement("div", {
    className: "pdf-bottom-grid grid gap-8 lg:grid-cols-2"
  }, /*#__PURE__*/React.createElement("section", {
    id: "pdf-section-03",
    className: "mck-panel p-5 md:p-6"
  }, /*#__PURE__*/React.createElement(SectionHead, {
    number: "03",
    title: "Season mix",
    ...
    className: "pdf-chart-sm h-[300px] w-full"
  }, /*#__PURE__*/React.createElement(ResponsiveContainer, {
    width: "100%",
    height: "100%"
    ...
    stroke: "#fff",
    strokeWidth: 2
  }, seasonData.map((entry, i) => /*#__PURE__*/React.createElement(Cell, {
    key: entry.name,
    fill: entry.name === "Others" ? "#A8B0B8" : PIE_COLORS[i % PIE_COLORS.length]
  }))), /*#__PURE__*/React.createElement(Tooltip, {
    content: /*#__PURE__*/React.createElement(PieTooltip, null)
  }), /*#__PURE__*/React.createElement(Legend, {
    iconType: "square",
    wrapperStyle: {
      fontSize: 12,
    ...
    className: "mt-3 grid grid-cols-2 gap-px bg-mck-line md:grid-cols-3"
  }, seasonData.map(s => /*#__PURE__*/React.createElement("div", {
    key: s.name,
    className: "bg-white px-3 py-2.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-[11px] font-semibold uppercase tracking-wider text-mck-gray"
  }, s.name), /*#__PURE__*/React.createElement("div", {
    className: "kpi-num mt-1 text-sm font-semibold text-mck-navy"
  }, fmt(s.value)), /*#__PURE__*/React.createElement("div", {
    className: "text-xs text-mck-gray"
  }, s.pct.toFixed(1), "%"))))), /*#__PURE__*/React.createElement("section", {
    id: "pdf-section-04",
    className: "mck-panel p-5 md:p-6"
  }, /*#__PURE__*/React.createElement(SectionHead, {
    number: "04",
    ...
    className: "mt-3 grid grid-cols-2 gap-px bg-mck-line"
  }, lifeCycleData.map(c => /*#__PURE__*/React.createElement("div", {
    key: c.fullName,
    className: "bg-white px-3 py-2.5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "text-[11px] font-semibold uppercase tracking-wider text-mck-gray"
  }, c.fullName), /*#__PURE__*/React.createElement("div", {
    className: "kpi-num mt-1 text-sm font-semibold text-mck-navy"
  }, fmt(c.total), " Units")))))), /*#__PURE__*/React.createElement("footer", {
    className: "mt-10 border-t border-mck-line pt-4 text-[11px] leading-relaxed text-mck-gray"
  }, "Zone map: 30 HighBay · 81/82/83 INFINITY · 02/04/05/06/08 Pickface \xA0|\xA0 Division: 10 AP · 20 FW · 30 EQ")));
}
